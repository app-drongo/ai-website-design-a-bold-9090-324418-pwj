...
export default function Cta() {
  const stats = [
    { value: "200+", label: "Brands Transformed", icon: Trophy },
    { value: "98%", label: "Client Satisfaction", icon: Sparkles },
    { value: "5M+", label: "Social Impressions", icon: Zap },
    { value: "24/7", label: "Creative Support", icon: Users }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join innovative startups and forward-thinking businesses who trust Neon Creative Studio 
                to transform their digital presence with cutting-edge creative solutions.
              </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Award-winning designs that make your brand stand out
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Rapid Delivery</h3>
              <p className="text-sm text-muted-foreground">
